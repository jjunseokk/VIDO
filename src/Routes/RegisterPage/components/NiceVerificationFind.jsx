...
const NiceVerificationFind = ({
  verification = false,
  setVeriNum = () => {},
  setDi = () => {},
  setVeriInfo = () => {},
  URL = `https://vido.gallery/signup/find-id`,
}) => {
  ...
  const reqData = {
    ...
    returnUrl: `https://vido.gallery/signup/find-id`,
    sitecode: '',
    authtype: 'M',
    popupyn: 'Y',
  };
    ...
    AxiosConfig.get(`/account/token`)
      .then((res) => {
        ...
        const openPopup = () => {
          ...
          const endVeriURL =
            /[(https://vido.gallery/signup/find-id?token_version_id=)+]/;
          document.form_chk.target = 'popupChk';
          document.form_chk.submit();
          console.log(popupVeri.document);
          console.log(popupVeri.location.href);
          console.log('-----');
          console.log(popupVeri.document.URL);
          let interval = null;
          setTimeout(() => {
            console.log('timeout');
...
export default NiceVerificationFind;
